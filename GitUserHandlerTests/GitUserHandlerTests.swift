...
class GitUserHandlerTests: XCTestCase {
    ...
    func testGitUser_create_new_user_by_json_data() throws {
        ...
        var gitUser = LocalDataSource().createGitHubUser(data)
            
        //fetch user from DB
        gitUser = LocalDataSource().getGitHubUser(id: "2")
    ...
    func testGitUser_update_model_with_detailed_json_data() throws {
        ...
        DispatchQueue.main.async {
            ...
            XCTAssertNotNil(detailedGitUser, "nil reference after GitUser update")
